#pragma once
// sha256.hpp — Self-contained SHA-256 implementation. No external dependencies.
// Usage: std::string digest = sha256("some input");
...
inline std::string sha256(const std::string& input) {
    ...
    // Pad: append 0x80, zero-fill, then original bit-length as 64-bit big-endian
